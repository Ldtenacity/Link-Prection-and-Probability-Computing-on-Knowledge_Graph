...
if __name__ == "__main__":
    ...
    # configs
    actor_config = ConfigClass(save_path="out/actor/actor_GAT_ckpt")
    chameleon_config = ConfigClass(save_path="out/chameleon/chameleon_GAT_ckpt")
    cora_config = ConfigClass(save_path="out/cora/cora_GAT_ckpt")
